...
Check out our live bot on Telegram for features demonstration
...
- To run the bot in the background:
  ...
  - To stop: `screen -r perry` and `screen -S perry -X quit`
...
Visit the [Terms of Use](TERMS_OF_USE.md) page to review and accept the guidelines.

## Important Note

**Note**: This bot is developed and maintained by Pushpa Bhau. Real development involves understanding the code, writing new functionalities, and debugging issues.

### Special thanks to:
- [RITIK](https://github.com/ for base development of this repository.
- [Mautrix Bridge](https://github.com/mautrix/telegram) for fast uploader connectivity bridge.
- Pushpa Bhau for customization and improvements.
